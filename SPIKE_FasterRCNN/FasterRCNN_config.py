...
__C.CNTK.E2E_LR_PER_SAMPLE = [0.001] * 100 + [0.0001] * 100 + [0.00001]
...
__C.RESULTS_NMS_THRESHOLD = 0.55
...
__C.RESULTS_BGR_PLOT_THRESHOLD = 0.4  # 0.4
...
__C.TRAIN.RPN_FG_FRACTION = 0.8     #0.5
# Total number of examples
__C.TRAIN.RPN_BATCHSIZE = 256
# NMS threshold used on RPN proposals
__C.TRAIN.RPN_NMS_THRESH = 0.8      #0.7
...
__C.TRAIN.FG_THRESH = 0.2  #0.5
# Overlap threshold for a ROI to be considered background (class = 0 if
# overlap in [LO, HI))
__C.TRAIN.BG_THRESH_HI = 0.2  #0.5
...
## NMS threshold used on RPN proposals
__C.TEST.RPN_NMS_THRESH = 0.8        #0.7
## Number of top scoring boxes to keep before apply NMS to RPN proposals
